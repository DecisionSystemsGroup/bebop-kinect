...
public class BebopActivity extends AppCompatActivity  {
   ...
   // private String received;
    ...
    boolean var1 = false;
    static boolean headJump = false;
    static boolean headJump2=false;
    static boolean rotateR = false;
    static boolean rotateL = false;
    static boolean moveR = false;
    static boolean moveL = false;
    static boolean moveF = false;
...
private void startConnectionThread(){
     ...
     t = new Thread(new Runnable() {
        ...
        public void run() {
            try {
                listener = new ServerSocket(1100);
                Socket sock = listener.accept();
                while(true){
                    din = new DataInputStream(sock.getInputStream());
                    byte[]  buffer = new byte[1];
                    din.read(buffer, 0, 1);
                    String received = new String(buffer, 0, 1);

                    if (!received.equals("")) {
                        switch (mBebopDrone.getFlyingState()) {
                            case ARCOMMANDS_ARDRONE3_PILOTINGSTATE_FLYINGSTATECHANGED_STATE_LANDED:
                                if (received.equals("U") && headJump == false)
                                {
                                    headJump=true;
                                    mBebopDrone.takeOff();
                                    received.equals("");
                            ...
                            case ARCOMMANDS_ARDRONE3_PILOTINGSTATE_FLYINGSTATECHANGED_STATE_FLYING:
                                if (received.equals("V") && headJump == true){
                            ...
                            case ARCOMMANDS_ARDRONE3_PILOTINGSTATE_FLYINGSTATECHANGED_STATE_HOVERING:
                                ...
                                if (headJump==true) {
                                    if (received.equals(">") && rotateR == false) {
                                        resetValues();
                                        rotateR = true;
                                    ...
                                    } else if (received.equals("<") && rotateL == false) {
                                    ...
                                    } else if (received.equals("F") && moveF == false) {
                                    ...
                                    } else if (received.equals("B") && moveB == false) {
                                    ...
                                    } else if (received.equals("R") && moveR == false) {
                                    ...
                                    } else if (received.equals("L") && moveL == false) {
                            ...
                            default:
                        }//end of coding landing and taking off

                    }//if the string is null code ending
                    if (sock.isClosed()) {
                        sock.close();
                        break;
                    }
    ...
    private void initIHM() {
        ...
        //starting coding from here


        mConnectBt = (Button)findViewById(R.id.connectButton);
